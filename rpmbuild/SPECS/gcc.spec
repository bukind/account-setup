...
BuildRequires: binutils >= 2.20.51.0.2-4
...
BuildRequires: gmp-devel >= 4.1.2-8, mpfr-devel >= 2.2.1, libmpc-devel >= 0.8
Requires(post): /sbin/install-info
Requires(preun): /sbin/install-info
Autoreq: true
...
Requires: gmp-devel >= 4.1.2-8, mpfr-devel >= 2.2.1, libmpc-devel >= 0.8
